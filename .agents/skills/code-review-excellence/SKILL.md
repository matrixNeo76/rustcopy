...
category: atom
version: 1.0.0
last_improved: 2026-05-05
improvement_log: "CoT: aggiunto Quick Start, tag versioning"
---
...
**Attiva questa skill dicendo all'agente:** "Fai code review di questa PR"
oppure "Rivedi il codice in [branch/PR]" o "Applica best practice di code review a [file]".

**Output:** Review strutturata con feedback costruttivo, bug trovati, suggerimenti.
