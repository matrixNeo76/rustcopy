...
`cargo test`: 310. `cargo test --features notify-server`: 325 (storico: 284 pre-D12 → 291 post-D12/D13 → 292 post-D14 → 298 → 299 post-D15 → 286/301 post-B3/B4 [17 Agosto 2026, 2 unit test aggiunti a fissare le due semantiche di merge exclude, vedi debito tecnico noto] → 296/311 post-P2 [19 Agosto 2026] → 302/317 post-P1 [19 Agosto 2026, 4 unit test + 2 black-box aggiunti, vedi `PIANO_MIGLIORAMENTI.md` §P1 — implementazione] → 307/322 post-D17 [21 Agosto 2026, 4 unit test + 1 black-box aggiunti, vedi `ANALYSIS.md` D17] → 310/325 post-D18 [22 Agosto 2026, 3 unit test aggiunti (2 test black-box preesistenti riscritti, non aggiunti), vedi `ANALYSIS.md` D18]).
