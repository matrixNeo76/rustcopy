...
`cargo test`: 302. `cargo test --features notify-server`: 317 (storico: 284 pre-D12 → 291 post-D12/D13 → 292 post-D14 → 298 → 299 post-D15 → 301 post-B3 [2 unit test aggiunti il 17 Agosto 2026 a fissare le due semantiche di merge exclude, vedi debito tecnico noto] → 302/317 post-P1 [19 Agosto 2026, 4 unit test + 2 black-box aggiunti, vedi `PIANO_MIGLIORAMENTI.md` §P1 — implementazione]).
