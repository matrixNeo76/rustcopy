...
- See `ANALYSIS.md` Parte 3 for the full post-5.1.0 defect list (D1-D10 — D1/D3/D4 now resolved) and `ROADMAP.md` milestones 5.2.0/5.3.0/6.0.0 for what is planned.
