...
- 📊 **[ANALYSIS.md](file:///c:/Users/auresystem/repos/robocopy-ingest-cli/ANALYSIS.md)** — Diagnosi delle criticità storiche e validazione dei 276 test.
...
## 🧪 Esecuzione dei Test (276 di Base, 291 con `notify-server`)

```bash
cargo test                              # 276 test (default build, senza axum)
cargo test --features notify-server     # 291 test (+15 test sul router axum e sui binari reali)
```
