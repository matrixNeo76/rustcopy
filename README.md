...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 505 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 520 test
```
