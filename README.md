...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 492 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 507 test
```
