...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 488 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 503 test
```
