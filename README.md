...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 501 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 516 test
```
