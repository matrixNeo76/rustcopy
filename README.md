...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 490 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 505 test
```
