...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 503 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 518 test
```
