...
```bash
cargo test --locked --workspace --exclude rustcopy-gui --all-targets                                   # 497 test
cargo test --locked --workspace --exclude rustcopy-gui --all-targets --features rustcopy-cli/notify-server  # 512 test
```
